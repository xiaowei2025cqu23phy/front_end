...
function animateStats() {
    ...
    const timer = setInterval(() => {
        ...
        linesElement.textContent = Math.floor(currentLines);
        projectsElement.textContent = Math.floor(currentProjects);
        ...
        if (frame >= totalFrames) {
            ...
            linesElement.textContent = targetLines;
            projectsElement.textContent = targetProjects;
        }
    }, 1000 / frameRate);
}
